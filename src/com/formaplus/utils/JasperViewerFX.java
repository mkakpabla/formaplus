...
public class JasperViewerFX extends Dialog<Void>{
    ...
    private BorderPane createContentPane() {
        btnPrint = new Button(null, new ImageView(getClass().getResource("/com/formaplus/resources/images/printer.png").toExternalForm()));
        btnSave = new Button(null, new ImageView(getClass().getResource("/com/formaplus/resources/images/save.png").toExternalForm()));
        btnBackPage = new Button(null, new ImageView(getClass().getResource("/com/formaplus/resources/images/backimg.png").toExternalForm()));
        btnFirstPage = new Button(null, new ImageView(getClass().getResource("/com/formaplus/resources/images/firstimg.png").toExternalForm()));
        btnNextPage = new Button(null, new ImageView(getClass().getResource("/com/formaplus/resources/images/nextimg.png").toExternalForm()));
        btnLastPage = new Button(null, new ImageView(getClass().getResource("/com/formaplus/resources/images/lastimg.png").toExternalForm()));
        btnZoomIn = new Button(null, new ImageView(getClass().getResource("/com/formaplus/resources/images/zoomin.png").toExternalForm()));
        btnZoomOut = new Button(null, new ImageView(getClass().getResource("/com/formaplus/resources/images/zoomout.png").toExternalForm()));
    ...
    private void exportTo(File file, String extension) {
        ...
        AlertMessage.showInformation("Fichier exporté");
    }
    ...
    public void viewReport(String title, JasperPrint jasperPrint, Control control) {
        this.jasperPrint = jasperPrint;
